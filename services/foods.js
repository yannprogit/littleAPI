...
const foodsForLakojary = [
  ...
  { id: 2, name: "Croissant", price: 2.50, description: "Une pâtisserie française classique", image: "http://localhost:8000/foods/2/image", stock: 320 },
  { id: 3, name: "Pain au Chocolat", price: 2.75, description: "Pâte feuilletée avec une garniture de chocolat", image: "http://localhost:8000/foods/3/image", stock: 90 },
  { id: 4, name: "Éclair", price: 4.00, description: "Longue pâtisserie fourrée à la crème et recouverte de glaçage", image: "http://localhost:8000/foods/4/image", stock: 250 },
  { id: 5, name: "Macaron", price: 1.75, description: "Biscuit meringué aux amandes colorées avec une garniture", image: "http://localhost:8000/foods/5/image", stock: 420 },
  { id: 6, name: "Rouleau à la cannelle", price: 3.00, description: "Rouleau sucré à la cannelle et au glaçage", image: "http://localhost:8000/foods/6/image", stock: 150 },
  { id: 7, name: "Pain au levain", price: 4.50, description: "Pain artisanal avec une saveur acidulée", image: "http://localhost:8000/foods/7/image", stock: 300 },
  { id: 8, name: "Pâtisserie danoise", price: 3.25, description: "Pâte feuilletée avec diverses garnitures sucrées", image: "http://localhost:8000/foods/8/image", stock: 80 },
  { id: 9, name: "Bretzel", price: 2.00, description: "Snack en forme de torsade, souvent salé", image: "http://localhost:8000/foods/9/image", stock: 470 },
  { id: 10, name: "Focaccia", price: 5.00, description: "Pain plat italien aux herbes et à l'huile d'olive", image: "http://localhost:8000/foods/10/image", stock: 120 },
  { id: 11, name: "Brioche", price: 3.75, description: "Pain sucré à la levure, souvent aux œufs et au beurre", image: "http://localhost:8000/foods/11/image", stock: 390 },
  { id: 12, name: "Scone", price: 2.25, description: "Pâtisserie britannique, généralement sucrée ou salée", image: "http://localhost:8000/foods/12/image", stock: 220 },
  { id: 13, name: "Pain Perdu", price: 6.50, description: "Pain trempé dans des œufs et du lait, puis frit ou cuit au four", image: "http://localhost:8000/foods/13/image", stock: 170 },
  { id: 14, name: "Pain Pita", price: 1.50, description: "Pain plat, légèrement levé et moelleux", image: "http://localhost:8000/foods/14/image", stock: 280 },
  { id: 15, name: "Ciabatta", price: 4.25, description: "Pain blanc italien, moelleux avec une mie poreuse", image: "http://localhost:8000/foods/15/image", stock: 430 },
  { id: 16, name: "Pumpernickel", price: 3.00, description: "Pain noir dense allemand", image: "http://localhost:8000/foods/16/image", stock: 100 },
  { id: 17, name: "Crumpet", price: 2.75, description: "Gâteau anglais à la poêle avec des pores caractéristiques", image: "http://localhost:8000/foods/17/image", stock: 350 },
  { id: 18, name: "Panettone", price: 7.00, description: "Pain sucré italien, souvent apprécié pendant Noël", image: "http://localhost:8000/foods/18/image", stock: 200 },
  { id: 19, name: "Kouign-Amann", price: 5.50, description: "Pâtisserie bretonne, connue pour ses couches de beurre et de sucre", image: "http://localhost:8000/foods/19/image", stock: 450 },
  { id: 20, name: "Bagel", price: 2.50, description: "Petit pain en forme d'anneau, souvent bouilli avant la cuisson", image: "http://localhost:8000/foods/20/image", stock: 60 },
  { id: 21, name: "Pain de seigle", price: 3.25, description: "Pain fabriqué avec un mélange de farine de seigle et de blé", image: "http://localhost:8000/foods/21/image", stock: 390 },
  { id: 22, name: "Pain de maïs", price: 2.00, description: "Pain fait avec de la semoule de maïs, un aliment de base de la cuisine du Sud", image: "http://localhost:8000/foods/22/image", stock: 80 },
  { id: 23, name: "Pain Anadama", price: 4.75, description: "Pain du Nouveau-England fait avec de la farine de blé, de la semoule de maïs et de la mélasse", image: "http://localhost:8000/foods/23/image", stock: 320 },
  { id: 24, name: "Pain plat", price: 2.50, description: "Pain non levé, souvent mince et croustillant", image: "http://localhost:8000/foods/24/image", stock: 130 },
  { id: 25, name: "Pandoro", price: 8.00, description: "Pain sucré italien, similaire au panettone", image: "http://localhost:8000/foods/25/image", stock: 270 },
  { id: 26, name: "Baklawa", price: 2.25, description: "Gâteau maghrébin aux cacahuètes", image: "http://localhost:8000/foods/26/image", stock: 0 },
  { id: 27, name: "Zlabia", price: 2.00, description: "Confiserie traditionnelle nord-africaine", image: "http://localhost:8000/foods/27/image", stock: 180 },
];
